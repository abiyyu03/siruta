...
type MemberStatusHttp struct {
	memberStatusUsecase member_status.MemberStatusUsecaseInterface
}

func NewMemberStatusHttp(memberStatusUC member_status.MemberStatusUsecaseInterface) *MemberStatusHttp {
	return &MemberStatusHttp{
		memberStatusUsecase: memberStatusUC,
	}
}
